# S&P 500 Stock List (Cached Backup)
# Last Updated: November 2025
# Use this if Wikipedia fetch fails
...
SP500_TICKERS = [
    ...
    'SCHW', 'SHW', 'SJM', 'SLB', 'SMCI', 'SNA', 'SNPS', 'SO', 'SOFi', 'SPG',
...
def get_cached_sp500() -> list:
    """Return cached S&P 500 list"""
    return SP500_TICKERS.copy()

if __name__ == "__main__":
    tickers = get_cached_sp500()
    print(f"Cached S&P 500 list contains {len(tickers)} stocks")
